...
let b = new PrefixPredicate('asdf=1');
let br = b.eval({ asdf: 1 }); // true

let c = new PrefixPredicate('&(qewr = 1)(1234=1234)');
let cr = c.eval({ qewr: 1 }); // true

let d = new PrefixPredicate('|(&(qewr = (1=1))(1234=1234))(&(qewr = 1)(1234=1234))');
let dr = d.eval({ qewr: true }); // true

let e = new PrefixPredicate('|(asdf > abc)!(xyz = xyz)(asdf = sdf asdf)');
let er = e.eval(); // true

let f = new PrefixPredicate('&(!(asdf = sdf))(!(asdf = sdf))');
let fr = f.eval(); // true
